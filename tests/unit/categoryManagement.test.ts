 ...
 * Migrado desde pruebas_escenarios/CP009-CP010-CategoryManagement.test.ts
 * 
 * Principios FIRST:
 * - Fast: Sin dependencias externas
 * - Independent: Cada test con su propio estado
 * - Repeatable: Usa fixtures consistentes
 * - Self-validating: Assertions automáticas
 * - Timely: Tests de lógica de negocio
 * 
 * Patrón AAA aplicado
 * Test Doubles: Mocks de dependencias
 */
...
// Base de datos simulada (Test Double: Fake)
let mockCategories: Categoria[] = [];
let nextCategoryId = 1;

// Funciones de negocio (equivalentes a servicios)
export const getUserCategories = (usuario: Usuario): GetCategoriesResponse => {
  // Arrange interno: Validaciones de entrada
  ...
  // Act: Filtrar y ordenar categorías
...
describe('Gestión de Categorías - Lógica de Negocio', () => {
  ...
  describe('getUserCategories - Obtener categorías del usuario', () => {
    it('debe listar categorías del usuario autenticado', () => {
      ...
      // Fluent assertions: Verificar que todas las categorías pertenecen al usuario
