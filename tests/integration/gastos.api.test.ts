/**
 * Pruebas de integración para API de Gastos
 * 
 * Principios FIRST:
 * - Fast: Usa mocks en lugar de BD real
 * - Independent: Cada test con su propio setup
 * - Repeatable: Mocks consistentes
 * - Self-validating: Assertions automáticas
 * - Timely: Tests de integración para validar flujo completo
 * 
 * Patrón AAA aplicado
 * Test Doubles: Mocks de Prisma y Clerk
 */
...
describe('API Gastos - Pruebas de Integración', () => {
  ...
  beforeEach(() => {
    // Arrange: Resetear todos los mocks antes de cada test (FIRST: Independent)
    jest.clearAllMocks();
